...
ARG GITHUB_TOKEN
RUN echo "@agile-crafts-people:registry=https://npm.pkg.github.com" > .npmrc && \
...
LABEL org.opencontainers.image.source="https://github.com/agile-crafts-people/impact_classifier_spa"

ENV API_HOST=impact_classifier_api
ENV API_PORT=9102
